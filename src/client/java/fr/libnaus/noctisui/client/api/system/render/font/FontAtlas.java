...
public class FontAtlas implements QuickImports {
    ...
    public FontAtlas(final ResourceManager manager, final String name) throws IOException {
        this(
                ...
                manager.open(Identifier.of(NoctisUI.MODID, "fonts/" + name + ".png"))
        );
    }
    ...
    public void renderWithShadow(final MatrixStack matrices, final String text, final float x, final float y, final int color) {
        RenderSystem.setShaderColor(0.25F, 0.25F, 0.25F, 1.0F);
        this.render(matrices, text, x + 0.75F, y + 0.75F, size, color);
        RenderSystem.setShaderColor(1f, 1f, 1f, 1f);
        this.render(matrices, text, x, y,size, color);
    ...
    public void drawStringWithShadow(MatrixStack matrices,
                                     String text,
                                     float x,
                                     float y,
                                     int argbColor) {
